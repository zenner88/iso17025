<?
  			...
  			$tmpcetak.= "
				<table  $bordercetak    >
					<tr   align=center valign=middle>
						...
						<td nowrap ><b> Vol. Pelarutan<br>Contoh = e<br> (mL)</td>
						<td nowrap ><b> Vol. Larutan<br>Yg diambil u/ <br>keperluan  inversi = f<br>(mL)</td>
						<td nowrap ><b> Faktor <BR> Pengenceran = e/f <br></td>
						<td nowrap ><b> Vol. Pelarutan<br>Hasil Inversi <br> (mL)</td>
		...
		$tmpcetak=str_replace("<--JUDUL-->","PENENTUAN KADAR GULA PEREDUKSI MENGGUNAKAN CARA LUFF SCHOORL",$tmpcetak);
